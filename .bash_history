#
passwd
Ubuntu comes with ABSOLUTELY NO WARRANTY, to the e
passwd
cp -r /home/testcase/hw1/ .
flex
flex scanner.l
ls
gcc lex.yy.c -lfl
cd hw1
cd ..
cp scanner.l /home/cd23p069/hw1/
cd hw1
golden_scanner < sample_textcase.txt
golden_scanner < sample_testcase.txt
flex scanner.l sample_testcase.txt
ls
gcc lex.yy.c -lfl
flex scanner.l sample_testcase.txt
gcc lex.yy.c -lfl
...
make
make test
golden_scanner std::cout << "INT_MAX: " << INT_MAX << std::endl;
std::cout << "INT_MAX: " << INT_MAX << std::endl;

golden_scanner < cout << "INT_MAX" << '\n';
golden_scanner < sample_testcase.txt
make clean
make
make test
...
golden_scanner < sample_testcase.txt
make test
cp -r /home/testcase/hw1/scoring_testcase/ /hw1
cd hw1
cp -r /home/testcase/hw1/scoring_testcase/ .
make test
golden_scanner < sample_testcase.txt
make test
golden_scanner < sample_testcase.txt
...
cd hw1
make test
golden_scanner < testcase.txt
golden_scanner < sample_testcase.txt
make test
cp /home/cd23p069/hw1/scanner.l /home/cd23p069/hw2/
cp /home/cd23p069/hw1/makefile /home/cd23p069/hw2/
...
make
make conflict
git clone https://github.com/bsraya/nthu-compiler-design.git
cd /home/cd23p069/hw2/nthu-compiler-design/hw2/
make
.
./parser
cd ..
...
git config --global user.email david5061@gmail.com
git config --global user.name johnson684
git commit -m "first commit"
git remote add https://github.com/johnson684/compiler.git
git remote add origin https://github.com/johnson684/compiler.git
